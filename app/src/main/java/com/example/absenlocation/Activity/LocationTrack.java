...
public class LocationTrack extends Service implements LocationListener {
    ...
    public LocationTrack(LogLocation home, LogLocationInterface.Views views) {
    ...
    public void onLocationChanged(Location location) {
        controller = new LogLocationController(homeContext, views);
        controller.updateLocation(mContext);
    }
